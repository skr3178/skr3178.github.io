# Markdown Paste (Container-Friendly)
...
- `MarkdownPaste.enableImgTag`
  ...
  Enable/disable using HTML img tag with width and height for pasting image. If this option be enabled, you can input width and height by using `<filepath>[?width,height]` in filename confirm input box. for example input `bcilename.png?200,100`, then `<img src='bcilename.png' width='200' height='100' />` will be inserted.
