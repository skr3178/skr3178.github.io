...
> **Now available as a Python package!** Install TurboQuant directly into your HuggingFace pipeline:
>
> ```bash
...
> ```
>
> 2-bit keys + values = ~8x memory reduction with attention quality within ~2.7x of the Shannon limit. [PyPI](https://pypi.org/project/turboquant-explained/) | [GitHub](https://github.com/skr3178/TurboQuant-explained)
...
![Beta marginal distribution for a single coordinate on the 3D unit sphere](/assets/posts/turboquant-explained/experiments/results/math_validation/beta_marginal_3d.png)
...
![Energy spreading after random rotation](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test1_energy_spreading.png)
*Random rotation spreads uneven energy across all coordinates, enabling uniform scalar quantization.*

![Energy spreading — low-dimensional case (d=3)](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test1_energy_spreading_d3.png)
*Energy spreading illustrated in d=3 for visual clarity.*

![Beta distribution fit to rotated coordinates](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test2_distribution_fit.png)
*Empirical distribution of rotated coordinates vs. theoretical Beta/Gaussian fit.*

![Near-independence of coordinates after rotation](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test3_near_independence.png)
*Pair-wise correlation of coordinates after rotation — near-zero off-diagonal entries confirm near-independence.*

![Correlation scaling with dimension](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test3b_correlation_scaling.png)
*Off-diagonal correlation decays as d increases, validating the independence assumption.*

![MSE payoff vs bit-width](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test4_mse_payoff.png)
*Empirical MSE vs theoretical upper and lower bounds across bit-widths b=1..4 on synthetic unit vectors.*

![MSE dimension scaling](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/test4b_dimension_scaling.png)
*MSE as a function of dimension d — confirms the distortion-rate bound scales correctly with d.*

![Figure 3 — synthetic](/assets/posts/turboquant-explained/experiments/results/phase1_synthetic/Fig_3_synthetic.png)
...
![GloVe MSE validation](/assets/posts/turboquant-explained/experiments/results/phase2_glove/glove_mse_300d.png)
...
![Figure 1 — Inner-product error distribution](/assets/posts/turboquant-explained/experiments/results/phase3_dbpedia/Fig_1_error_histograms.png)
...
![Figure 2 — Error grouped by average inner product](/assets/posts/turboquant-explained/experiments/results/phase3_dbpedia/Fig_2_grouped_histograms.png)
...
![Figure 3 — Distortion vs bit-width](/assets/posts/turboquant-explained/experiments/results/phase3_dbpedia/Fig_3_dbpedia.png)
